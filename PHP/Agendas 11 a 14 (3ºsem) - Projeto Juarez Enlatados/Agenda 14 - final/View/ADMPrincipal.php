...
w3-margin w3-center">
            ...
            <button name="btnListarCadastrados" class="w3-button w3-margin w3-blue w3-cell w3-round-large">
                <br>
                <i class="fa-regular fa-address-book w3-xxlarge" style="color: #ffffff;"></i>
                <br>
                <p class="w3-xlarge">
                    Usuários
                    <br>
            ...
            <button name="btnListarAdministradores" class="w3-button w3-margin w3-indigo w3-cell w3-round-large">
                <br>
                <i class="fa-regular fa-address-card w3-xxlarge" style="color: #ffffff;"></i>
                <br>
                <p class="w3-xlarge">
                    Adms.
                    <br>
